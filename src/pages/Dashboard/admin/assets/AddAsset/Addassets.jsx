...
const Addassets = () => {
  ...
  const handelSubmit = (e) => {
    ...
    try {
      ...
      pdfs.forEach((item) => formData.append('pdf', item.file));
  ...
  return (
    <div className="w-full">
      ...
      <form
        ...
        className="w-full h-full grid grid-rows-1	lg:grid-rows-3 shadow-md p-5	"
      >
        {/* بيانات اساسيه  ref to genarlildata*/}
        {SelectedType === 'genarlildata' && (
          <AssetFormmainData
        ...
        {SelectedType === 'genarlildata' ? (
          ...
          <span className="text-red-500">
            يجب رجوع للبيانات الرئيسيه لحفظ جميع البيانات
          </span>
        )}
      </form>
    </div>
