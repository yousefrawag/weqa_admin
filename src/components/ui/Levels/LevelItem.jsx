  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative w-full max-w-sm">
        <div className="py-2 text-white px-4 bg-main shadow-2 rounded-md text-center flex justify-between items-center cursor-pointer hover:bg-main-dark transition-colors">
