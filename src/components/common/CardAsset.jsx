...
const CardAsset = ({id ,to , img , title ,tosub , enddpointDelete , isDropdownVisible ,toggleDropdown , hasSub}) => {
  ...
  return (
         <div
               ...
               className="w-full lg:w-[250px] relative rounded-md border rounded-[10px] border-stroke bg-white h-[250px] shadow-default dark:border-strokedark dark:bg-boxdark flex justify-start flex-col border-main focus:outline-none focus:bg-[#804DB8]/20 dark:focus:bg-[#804DB8]/20 dark:border-main"
           >
             <div className="absolute top-2 left-3">
                ...
                </button>
              {
                ...
                {
                  hasSub && <Link   to={tosub} className="text-md text-main2 font-medium dark:text-black flex items-end justify-end">إضافة فرع اخر</Link> 
                } 
                <button
               ...
               <img src={img} alt='icon-category' className='w-full h-[80%] object-cover	rounded-[10px]' />
