...
import { FaGripHorizontal, FaUsers  , FaCalendarAlt } from 'react-icons/fa';
          ...
          وقاء ادمن
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item assets --> */}
              {
               ...
               {
                    isOwner || permissions?.assets?.actions?.some((key) => key === "Canviewclanderassets") ?
                    <li>
                    <NavLink
                      to="/Assets-Clander"
                      className={`${liststyle} ${
                        pathname.includes('Assets-Clander') &&
                        'text-main border-main mr-6 dark:!text-main bg-gray-100 dark:bg-gray-800'
                      }`}
                    >
                      <FaCalendarAlt  />
              ...
              {/* <!-- Menu Item users --> */}
              {
                 ...
                 <NavLink
                   ...
                   className={`${liststyle} ${
                     pathname.includes('all-edit-requests') &&
                     'text-main border-main mr-6 dark:!text-main bg-gray-100 dark:bg-gray-800'
                   }`}
                 >
                   <FaUsers />
